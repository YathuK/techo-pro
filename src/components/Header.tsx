  ...
  return (
    <header className="h-16 bg-white border-b border-stone-200 flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-4">
        {/* AI Quick Action */}
        <button className="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-accent/10 to-accent/5 border border-accent/20 rounded-lg text-sm font-medium text-accent hover:from-accent/20 hover:to-accent/10 transition-all ai-glow">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-stone-200">
          ...
          <div className="w-9 h-9 bg-charcoal-900 rounded-full flex items-center justify-center">
            <User className="w-5 h-5 text-cream-200" />
          </div>
        </div>
      </div>
    </header>
